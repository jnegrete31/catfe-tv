...
export const DONATION_TIERS = [
  {
    ...
    tokens: 1,
    description: "1 extra vote for your favorite cat photo",
  },
  {
    id: "tier_2",
    label: "Cat Nap",
    ...
    tokens: 5,
    description: "5 extra votes — help your fave rise to the top!",
  },
  {
    id: "tier_3",
    label: "Full Purr",
    ...
    tokens: 15,
    description: "15 extra votes — the ultimate cat champion boost!",
  },
] as const;
