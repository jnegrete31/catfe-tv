    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 py-8 px-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Happy Tails</h1>
          <p className="text-gray-600">
            Share a photo of your adopted Catfé cat in their new home!
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your photo will be displayed on our TV for visitors to see
            </CardDescription>
          </CardHeader>
          <CardContent>
